...
app.post("/payment", async (req, res) => {
    try {
      ...
      const itemProducts = products.map((itemproduct) => ({
        price_data: {
          ...
          product_data: {
            ...
            images: [`https://backendcapstone-xxrp.onrender.com/Images/${itemproduct.image}`], // Use base 64 to work properly the image
          },
      ...
      const session = await stripe.checkout.sessions.create({
        ...
        mode: "payment",
        success_url: "https://main--luxiraloomsite.netlify.app/successpayment", // if success go to success url
        cancel_url: "https://main--luxiraloomsite.netlify.app/cart",
      });
