...

                                {
                                    ...
                                    <div id="dashboard1" className="shop-tab-content">
                                        <div className="p-8 border border-gray-600">
                                            ...
                                            <p>
                                                Hello, <strong>{user?.user.firstName} {user?.user.lastName}</strong> !
                                            </p>
                                            <p>
                                        ...
                                        <div className="p-8 border border-gray-600">
                                            ...
                                            <address className="not-italic">
                                                ...
                                                <p>
                                                    ...
                                                    {user?.user.city} {user?.user.postalCode} <br />
                                                    {user?.user.province}
                                                </p>
                                                <p>Email: {user?.user.email}</p>
                                            </address>

                                            {/* <Link className="transition-all hover:text-orange">Edit Address</Link> */}
                                        </div>
                                    </div>
                                }
